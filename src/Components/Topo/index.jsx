      ...
      <div className="limitar-secao navbar">
        ...
        <nav>
          ...
          <div className={ativar}>
            <a href="#home" className="link-topo link-home" to="/">
              Home
            </a>
            <a href="#sobre" className="link-topo" to="/Sobre">
              Sobre
            </a>
            <a href="#skills" className="link-topo" to="/Skills">
              Skills
            </a>
            <a href="#projetos" className="link-topo" to="/Projetos">
              Projetos
            </a>
            {/* <a href='#contato' className='link-topo' to="/Projetos">Contato</a> */}
            <a href="#certificados" className="link-topo" to="/Certificados">
              Certificados
            </a>
          </div>
        </nav>
